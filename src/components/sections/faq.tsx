...
const faqData = [
  ...
  },
  {
    ...
    answer: "Актуальный lucky bear промокод или купон lucky bear всегда можно найти в нашем официальном боте. Подпишитесь на лакибир тг, чтобы получать эксклюзивные предложения и бонусы, недоступные обычным игрокам. Также промокод luckybear часто рассылается активным пользователям на почту.",
  },
  {
